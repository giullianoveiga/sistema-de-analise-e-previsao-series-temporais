...
st.set_page_config(
    page_title="Sistema de Análise e Previsão de Series Temporais",
    layout="wide"
)

st.title("Sistema de Análise e Previsão de Series Temporais")
...
with st.sidebar:
    ...
    if uploaded_file is not None:
        ...
        data_start = date(2000,1,1)
        periodo = st.date_input("Selecione o período", value=data_start)
        periodo_previsao = st.number_input("Selecione o período de previsão (em meses)", min_value=1, max_value=48, value=12)
